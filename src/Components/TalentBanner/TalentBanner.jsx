...
const TalentBanner = () => {
    return (
      ...
      <div className='mt-10'>
      <button class="px-10 py-4 font-medium tracking-wide text-white text-lg capitalize transition-colors duration-300 transform bg-green-400 rounded-lg hover:bg-green-500 focus:outline-none ">
    Get Started
</button>
      </div>
        </section>
