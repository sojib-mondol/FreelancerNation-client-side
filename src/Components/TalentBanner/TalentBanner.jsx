...
const TalentBanner = () => {
  return (
    <section className="talentBanner flex justify-center mt-10 flex-col px-4 py-5 mx-auto md:px-24 overflow-hidden">
      ...
      <div className='mt-10'>
        <button className="px-10 py-4 font-medium tracking-wide text-white text-lg capitalize transition-colors duration-300 transform bg-green-400 rounded-lg hover:bg-green-500 focus:outline-none ">
          Get Started
        </button>
      </div>
    </section>
