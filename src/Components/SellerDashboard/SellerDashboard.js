    ...
    queryFn: async () => {
      try {
        const res = await fetch(
          `https://freelancer-nation-backend.vercel.app/seller/gig/${user?.email}`
        );
        ...
        <div className='xl:col-span-4 bg-white flex flex-col items-center p-5 border border-slate-300'>
          <div className='w-48 h-48 rounded-full relative'>
            <img
              ...
              alt='user'
            />
            <div className='absolute top-[153px] left-[120px]'></div>
          </div>
          ...
          <div className='flex flex-col gap-2 items-center mt-5'>
            ...
            <div className='flex items-center justify-between w-full my-2'>
              <Link to='/becomeASeller/service_category/registerseller'>
                <div className='flex items-center bg-green-400 rounded-md'>
                  <button>
                    <svg
                      width='40px'
                      height='40px'
                ...
                <div className='flex items-center bg-green-400 rounded-md'>
                  <button>
                    <svg
                      width='40px'
                      height='40px'
                      viewBox='-22.56 -22.56 69.12 69.12'
                      fill='none'
                      xmlns='http://www.w3.org/2000/svg'
                    >
                      <g id='SVGRepo_bgCarrier' stroke-width='0'></g>
        ...
        <div className='xl:col-span-8'>
          <div>
            <div className='bg-white p-3 border border-slate-300'>
              <h2 className='uppercase font-bold text-sm text-start'>
                Active gigs
              </h2>
            </div>
            ...
            <div className='grid grid-cols-1 xl:grid-cols-3 gap-5 mt-5 xl:mt-10'>
              ...
              <Link
                to='/seller_dashboard/create-gig'
                className='w-full overflow-hidden bg-white border border-slate-300 flex flex-col justify-center items-center py-7'
              >
